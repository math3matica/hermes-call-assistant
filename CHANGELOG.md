...
- Added explicit `hermes call-assistant` and `hermes-call-assistant` activation paths without changing `/voice`.
- Packaged the existing `call assistant runtime` runtime, Pi extension, capability bridge, and post-call modules.
